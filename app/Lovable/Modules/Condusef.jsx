...
export default function CondusefSection() {
    return (
        <div className="bg-[var(--white)] p-8 md:p-12 lg:p-16 flex justify-center">
            <div className="bg-gray-50 p-6 md:p-10 rounded-2xl shadow-xl w-full max-w-4xl flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div className="flex-1 flex flex-col justify-between space-y-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <p className="font-semibold text-gray-700 text-lg">Teléfono CONDUSEF</p>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <p className="font-semibold text-gray-700 text-lg">¿Tienes una queja?</p>
                ...
                <div className="flex-1 flex flex-col justify-between w-full lg:w-auto">
                    <div className="bg-[var(--white)] p-8 rounded-2xl border border-[var(--border)] mb-6 shadow-md">
                        <h3 className="font-bold text-xl text-gray-800 mb-4">Nuestros Registros</h3>
                    ...
                    <button className="w-full py-4 px-6 text-[var(--color-primary)] text-[var(--white)] font-semibold rounded-xl shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-[var(--color-primary)] focus:ring-opacity-50 transition-all duration-300">

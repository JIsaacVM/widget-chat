            ...
            <main className="relative z-10 p-8 md:p-12 lg:p-20 text-[var(--white)] flex flex-col items-center lg:items-start lg:flex-row gap-12 lg:gap-20">
                ...
                >
                    ...
                    <div className="mt-8 space-y-2 text-lg text-[var(--white)]/90">
                        <p className="flex items-center justify-center lg:justify-start">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="size-6 stroke-2 stroke-[var(--color-primary)] mr-2">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-8 items-center justify-center lg:justify-start">
                        <a className="bg-[var(--color-primary)] text-[var(--white)] px-6 py-3 rounded-full font-semibold hover:bg-[var(--color-primary-dark)] transition-colors" href="#">
                ...
                <div className="grid grid-cols-2 gap-6 mt-12 lg:mt-0 w-full max-w-lg lg:max-w-xl">
                    ...
                    <div
                        ...
                        data-aos-delay="200"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="size-16 stroke-[var(--color-primary)] mb-2">
                            <path d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                        </svg>
                        <p className="text-2xl lg:text-4xl font-extrabold text-[var(--white)]">50,000+</p>
                        <p className="text-[var(--white)]">Clientes atendidos</p>
                    </div>
                    ...
                    >
                        ...
                        <p className="text-[var(--white)]">Años de experiencia</p>
                    </div>
                    ...
                    >
                        ...
                        <p className="text-[var(--white)]">Operaciones exitosas</p>
                    </div>
                    ...
                    >
                        ...
                        <p className="text-[var(--white)]">Índice de satisfacción</p>
                    </div>
                </div>
            </main>
        </div>

        ...
        >
            ...
            >
                <form className="bg-[var(--white)] p-8 rounded-lg shadow-lg">
                    ...
                    <textarea placeholder="Mensaje" rows="4" className="w-full p-3 mt-6 border border-[var(--black)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"></textarea>
